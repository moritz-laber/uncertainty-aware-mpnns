"""
moment_comparison_synthetic.py
----------
...
diagW2 = False                         # wheter to use only the diagonal of the output covariance
eps = 1e-15                            # small constant for numerical stability in matrix square roots
...
with open(f'{output_dir}{corr}/comparison_model=gcn_corr={corr}_nonlin={nonlin_str}_l={num_layers}_hidden={num_hidden}_reps={num_reps}.pkl', 'wb') as f:
